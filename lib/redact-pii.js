...
// Redacts a whole listing submission: title, description, and every message
// in the thread. Returns the redacted versions plus a merged findings list.
export function redactListing({ title, description, messages }) {
