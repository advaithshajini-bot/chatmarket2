      ...
      {open && (
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <button type="button" onClick={() => setViewDate(new Date(year, month - 1, 1))} className="p-1">
          ...
          <button type="button" onClick={() => { onChange(""); setOpen(false); }} className="w-full text-center text-xs mt-2 py-1.5" style={{ color: "#6B6F76", fontFamily: "'IBM Plex Sans', sans-serif" }}>
            Clear
          </button>
        </div>
      )}
